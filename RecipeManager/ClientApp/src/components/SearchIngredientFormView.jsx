...
import { Form, Button, Control, Label, FormGroup, Input} from 'reactstrap';
    ...
    return (
      <div>
        ...
        <Form onSubmit={this.searchIngredient}>
            ...
            <Input type="text" name="text" placeholder="Enter an ingredint you have" innerRef={(i) => this.inputtaskValue = i}  />
