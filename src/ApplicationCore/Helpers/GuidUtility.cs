// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GuidUtility.cs" company="MasterChefs">
//   {{Copyright}}
// </copyright>
// <summary>
...
namespace RecipeManager.ApplicationCore.Helpers
{
	...
	/// Taken from: https://stackoverflow.com/a/5657517/1712861
	/// </summary>
	public static class GuidUtility
	{
		...
		/// <returns>A UUID derived from the namespace and name.</returns>
		public static Guid Create(Guid namespaceId, IEnumerable<byte> nameBytes) => Create(namespaceId, nameBytes, 5);
		...
		/// 3 (for MD5 hashing) or 5 (for SHA-1 hashing).</param>
		/// <returns>A UUID derived from the namespace and name.</returns>
		public static Guid Create(Guid namespaceId, IEnumerable<byte> nameBytes, int version)
		{
